      ...
      (cases expression exp
        ...
        (list-exp (args)
          (if (null? args)
              ...
              (value-of/k (car args)
                          env
                          (list-car-cont (list-exp (cdr args))
                                         env
                                         cont))))
   )))
      ...
      (cases continuation cont
        ...
        (null?-cont (saved-cont)
          (apply-cont saved-cont
                      (expval->null? val)))
        ; exercise 5.6
        (list-car-cont (list-cdr saved-env saved-cont)
          (value-of/k list-cdr
                      saved-env
                      (list-cdr-cont val saved-cont)))
        (list-cdr-cont (car-val saved-cont)
          (apply-cont saved-cont (pair-val car-val val)))
      )))
